      ...
      timeList: [
        ...
        },
        {
          ...
          list: [{
            ...
            desc: [{
              label: '项目描述',
              value: '因为58二手存在很严重的代码历史包袱，代码的维护和需求的迭代都有很高的人力成本，所以要对老旧代码进行组件化改版，降低维护成本，适应敏捷开发，快速迭代'
            }, {
              label: '使用技术',
            ...
            desc: [{
              ...
              label: '负责工作',
              value: ['通过vue框架实现我的优惠券，查看无效优惠券，优惠券跳转，兑换优惠券等功能', '学习webpack打包，实现前端工程化']
            }]
          }, {
            ...
            desc: [{
              ...
              label: '负责工作',
              value: '登录注册改版，利用native中webView内嵌h5页面，客户端和h5之间通过商定的协议进行数据和状态的传输，实现用户登录，注册，滑块验证码的接入'
            }]
          }]
        }
      ],
